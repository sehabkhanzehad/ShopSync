    ...
    <aside id="sidebar-wrapper">
        ...
        <ul class="sidebar-menu">
            ...
            @if (auth()->user()->can('admin.all-order') ||
                    auth()->user()->can('admin.order-show') ||
                    auth()->user()->can('admin.pending-order') ||
                    auth()->user()->can('admin.delivered-order') ||
                    auth()->user()->can('admin.completed-order'))
                <li
                    ...
                    <a href="#" class="nav-link has-dropdown">
                        ...
                        <span style="color:black">{{ __('admin.Orders') }}</span>
                    </a>
                    <ul class="dropdown-menu">

                        <li class="{{ Route::is('admin.all-order') || Route::is('admin.order-show') ? 'active' : '' }}">
                            <a class="nav-link" href="{{ route('admin.all-order') }}">{{ __('admin.All Orders') }}</a>
                        </li>

                        <li class="{{ Route::is('admin.pending-order') ? 'active' : '' }}"><a class="nav-link"
                                href="{{ route('admin.pending-order') }}">{{ __('admin.Pending Orders') }}</a></li>

                        <li class="{{ Route::is('admin.process-order') ? 'active' : '' }}"><a class="nav-link"
                                href="{{ route('admin.process-order') }}">Process Orders</a></li>

                        <li class="{{ Route::is('admin.courier-order') ? 'active' : '' }}"><a class="nav-link"
                                href="{{ route('admin.courier-order') }}">Courier Orders</a></li>
                        <li class="{{ Route::is('admin.onhold-order') ? 'active' : '' }}"><a class="nav-link"
                                href="{{ route('admin.onhold-order') }}">On Hold Orders</a></li>
                        ...
                        <li class="{{ Route::is('admin.cancell-order') ? 'active' : '' }}"><a class="nav-link"
                                href="{{ route('admin.cancell-order') }}">Cancell Orders</a></li>
                        <li class="{{ Route::is('admin.return-order') ? 'active' : '' }}"><a class="nav-link"
                                href="{{ route('admin.return-order') }}">Return Orders</a></li>
            ...
            @if (auth()->user()->can('admin.pc-builder') ||
                    auth()->user()->can('admin.product-category') ||
                    auth()->user()->can('admin.product-sub-category') ||
                    auth()->user()->can('admin.product-child-category') ||
                    auth()->user()->can('admin.mega-menu-category') ||
                    auth()->user()->can('admin.mega-menu-sub-category') ||
                    auth()->user()->can('admin.create-mega-menu-sub-category') ||
                    auth()->user()->can('admin.edit-mega-menu-sub-category') ||
                    auth()->user()->can('admin.mega-menu-banner') ||
                    auth()->user()->can('admin.popular-category') ||
                    auth()->user()->can('admin.featured-category'))
                <li
                    class="nav-item dropdown {{ Route::is('admin.pc-builder.*') || Route::is('admin.product-category.*') || Route::is('admin.product-sub-category.*') || Route::is('admin.product-child-category.*') || Route::is('admin.mega-menu-category.*') || Route::is('admin.mega-menu-sub-category') || Route::is('admin.create-mega-menu-sub-category') || Route::is('admin.edit-mega-menu-sub-category') || Route::is('admin.mega-menu-banner') || Route::is('admin.popular-category') || Route::is('admin.featured-category') ? 'active' : '' }}">
                    ...
                    <a href="#" class="nav-link has-dropdown">
                        ...
                        <span style="color:black">{{ __('admin.Manage Categories') }}</span>
                    </a>
                    <ul class="dropdown-menu">
                        ...
                        <li class="{{ Route::is('admin.popular-category') ? 'active' : '' }}"><a class="nav-link"
                                href="{{ route('admin.popular-category') }}">Home Product Slide</a></li>
                        <!--<li class="{{ Route::is('admin.pc-builder') ? 'active' : '' }}"><a class="nav-link" href="{{ route('admin.pc-builder') }}">PC Builder</a></li>-->

                        <li class="{{ Route::is('admin.featured-category') ? 'active' : '' }}"><a class="nav-link"
                                href="{{ route('admin.featured-category') }}">{{ __('admin.Featured Category') }}</a>
                        </li>
            ...
            @if (auth()->user()->can('admin.product') ||
                    auth()->user()->can('admin.product-brand.index') ||
                    auth()->user()->can('admin.product-variant') ||
                    auth()->user()->can('admin.create-product-variant') ||
                    auth()->user()->can('admin.edit-product-variant') ||
                    auth()->user()->can('admin.product-gallery') ||
                    auth()->user()->can('admin.product-variant-item	') ||
                    auth()->user()->can('admin.create-product-variant-item') ||
                    auth()->user()->can('admin.edit-product-variant-item') ||
                    auth()->user()->can('admin.product-review') ||
                    auth()->user()->can('admin.show-product-review'))
                <li
                    ...
                    <a href="#" class="nav-link has-dropdown">
                        ...
                        <span style="color:black">{{ __('admin.Manage Products') }}</span>
                    </a>
                    <ul class="dropdown-menu">
                        ...
                        <li
                            ...
                            <a class="nav-link"
                                href="{{ route('admin.product.index') }}">{{ __('admin.Products') }}</a>
                        </li>
            ...
            @if (auth()->user()->can('admin.inventory'))
                <li class="{{ Route::is('admin.inventory') || Route::is('admin.stock-history') ? 'active' : '' }}"><a
                        class="nav-link" href="{{ route('admin.inventory') }}">
                        <div class="icon">
                            <i class="fas fa-money-check-alt"></i>
                        </div>
                        <span style="color:black">{{ __('admin.Inventory') }}</span>
                    </a></li>
            @endif
            ...
            @if (auth()->user()->can('FlashSale.index') ||
                    ...
                    auth()->user()->can('product.free-shipping'))
                <li
                    class="nav-item dropdown {{ Route::is('admin.flash-sale') || Route::is('admin.currency.*') || Route::is('admin.shipping.*') || Route::is('admin.coupon.*') || Route::is('admin.payment-method') || Route::is('admin.flash-sale-product') ? 'active' : '' }}">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li class="{{ Route::is('admin.flash-sale') ? 'active' : '' }}"><a class="nav-link"
                                href="{{ route('admin.flash-sale') }}">{{ __('admin.Flash Sale') }}</a></li>
            ...
            <!--@if (auth()->user()->can('admin.withdraw-method') ||
                    auth()->user()->can('admin.seller-withdraw') ||
                    auth()->user()->can('admin.pending-seller-withdraw') ||
                    auth()->user()->can('admin.show-seller-withdraw'))
-->
                ...
                <li class="{{ Route::is('admin.general-setting') ? 'active' : '' }}">
                    ...
                    <ul class="dropdown-menu">
                        @if (auth()->user()->can('admin.general-setting'))
                            ...
                            <li class="{{ Route::is('admin.courier-setting') ? 'active' : '' }}"><a class="nav-link"
                                    href="{{ route('admin.courier-setting') }}">Courier Setting</a></li>
                        @endif
                        @if (auth()->user()->can('admin.about-us.index'))
                            ...
                            <li class="{{ Route::is('admin.payment-method') ? 'active' : '' }}"><a class="nav-link"
                                    href="{{ route('admin.payment-method') }}">{{ __('admin.Payment Method') }}</a>
                            </li>
                        @endif
                        ...
                        <li class="{{ Route::is('admin.advertisement.*') ? 'active' : '' }}"><a class="nav-link"
                                href="{{ route('admin.advertisement') }}">
                                Footer Images</a>
                        </li>
                    </ul>
                </li>
...
@endif-->
            ...
            @if (auth()->user()->can('admin.customer-list') ||
                    auth()->user()->can('admin.customer-show') ||
                    auth()->user()->can('admin.pending-customer-list') ||
                    auth()->user()->can('admin.seller-list') ||
                    auth()->user()->can('admin.seller-show') ||
                    auth()->user()->can('admin.pending-seller-list') ||
                    auth()->user()->can('admin.seller-shop-detail') ||
                    auth()->user()->can('admin.seller-reviews') ||
                    auth()->user()->can('admin.show-seller-review-details') ||
                    auth()->user()->can('admin.send-email-to-seller') ||
                    auth()->user()->can('admin.email-history') ||
                    auth()->user()->can('admin.product-by-seller') ||
                    auth()->user()->can('admin.send-email-to-all-customer'))
                <li
