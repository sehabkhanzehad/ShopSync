                            ...
                            <div class="card-body">
                                <form action="" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-6">
                                            <label>Notes:</label>
                                            <textarea name="notes" id="notes" cols="30" rows="50" class="form-control">{{ $customer->notes }}</textarea>
                                        </div>
                                        ...
                                        <div class="form-group col-6">
                                            ...
                                            <div class="form-group mt-4">
                                                <img src="{{ $customer->image != null ? asset($customer->image) : 'https://placehold.co/100x100' }}"
                                                    class="rounded"
                                                    alt="Package Image"
