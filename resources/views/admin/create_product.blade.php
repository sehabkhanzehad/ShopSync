                                    ...
                                    <div class="row">
                                        ...
                                        <style>
                                            .preview-image {
                                                ...
                                                padding: 10px;
                                                margin-right: 5px;
                                                /* Optional: Add margin between preview images */
                                            }
                                        ...
                                        <div class="form-group col-4">
                                            ...
                                            <input type="file" class="form-control-file" name="images[]"
                                                onchange="previewProductImages(event)" multiple>
                                        ...
                                        <div class="form-group col-6">
                                            <label>{{ __('admin.Name') }} <span class="text-danger">*</span><span
                                                    class="text-danger" id="name_test"></span></label>
                                    ...
                                    <div class="row">
                                        <div class="col-md-5">
                                            <div id="variable_table_two" class="" style="display: none;">
                                                <div class="table-responsive">
                                                    <table
                                                        class="table table-centered table-nowrap table-bordered text-center size_table">
                                                        <thead>
                                                            <tr>
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <input class="variable_sell_price form-control"
                                                                        type="number" name="sell_price[]"
                                                                        placeholder="Price">
                                                                </td>
                                                                ...
                                                                <td>
                                                                    <a class="btn action-icon btn-primary add_moore"
                                                                        style="cursor: pointer;color: #ffffff;">Add </a>
                                                                </td>
                                                            </tr>
                                                        </tbody>
                                        ...
                                        <div class="col-md-7">
                                            <div id="variable_table_color" class="" style="display: none;">
                                                <div class="table-responsive">
                                                    <table
                                                        class="table table-centered table-nowrap table-bordered text-center color_table">
                                                        <thead>
                                                            <tr>
                                                        ...
                                                        <tbody>
                                                            <tr id="color_row">
                                                                ...
                                                                <td>
                                                                    <input class="variable_product_image form-control"
                                                                        type="file" name="var_images[]"
                                                                        placeholder="Price">
                                                                </td>
                                                                ...
                                                                <td>
                                                                    <a class="btn action-icon btn-primary add_moore_color"
                                                                        style="cursor: pointer;color: #ffffff;">Add </a>
                                                                </td>
                                                            </tr>
                                                        </tbody>
